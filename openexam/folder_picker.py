...
def pick_folder_macos(prompt: str = "Select OpenExam document folder") -> FolderPickerResult:
...
def pick_folder(prompt: str = "Select OpenExam document folder") -> FolderPickerResult:
    if platform.system() == "Darwin":
        return pick_folder_macos(prompt=prompt)
    return FolderPickerResult(None, False, "Folder picker is only implemented for macOS. Please enter the path manually.")
